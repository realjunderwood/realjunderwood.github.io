...
document.getElementById("REEnter").setAttribute('src', "./REEnter.wav");
document.getElementById("REEnterAudio").load();

document.getElementById("hellorrwp").setAttribute('src', "./hellorrwp.wav");
document.getElementById("hellorrwpAudio").load();


document.getElementById("leave").setAttribute('src', "./leave.wav");
